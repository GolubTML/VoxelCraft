...
private:
    ...
    void createImageViews()
    {
        ...
        {
            // let's create image create info
            ...
            // and now, let's create swapChain images view
    ...
    void createGraphicsPipeline()
    {
        ...
        // and now, we need to create shader pipeline for out shaders
        // for vertex
    ...
    void recordCommandBuffer(VkCommandBuffer buffer, uint32_t imageIndex)
    {
        ...
        VkClearValue clearColor = {{{0.f, 0.f, 0.f, 1.f}}}; // why there 3 '{}'?
    ...
    {
        // so here, like in open gl, we create shaders. BUT here, completely from scratch
        // as usual, let's create shader module createInfo
        VkShaderModuleCreateInfo createInfo{};
        createInfo.sType = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO;
        createInfo.codeSize = code.size();
        createInfo.pCode = reinterpret_cast<const uint32_t*>(code.data()); // byte code from .spv

        // and finally, let's create shader
